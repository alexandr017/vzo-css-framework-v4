let offersListItem = document.querySelectorAll('.offer-filters-title');
let offersListHiddenBlock = document.querySelectorAll('.offer-filters-hidden-block')[0];
let offersListCloseBtn = document.querySelectorAll('.offer-filters-hidden-top-line')[0];
let offersListHiddenTitleItem = document.querySelectorAll('.offer-filters-title-clicked')[0];
let offerFiltersSliderList = document.querySelectorAll('.offer-filters-slider-list')[0];
let offerListDotsBlock = document.querySelectorAll(".offer-slider-dots")[0];
