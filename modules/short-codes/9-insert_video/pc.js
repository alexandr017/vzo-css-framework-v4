...
for (let i = 0; i < videoBlock.length; i++) {
    videoBlock [i].addEventListener('click', function(){
        ...
        this.innerHTML = '<div class="iframe-shadow " style="line-height: 0;" ><iframe allowfullscreen class="border-radius" style="width: 100%; height: 300px"  src="'+ link +'" ></iframe></div>';
    });
}
